  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta property='og:image' content={`https://og-image.vercel.app/${encodeURI(siteTitle)}.png?theme=ight&md=0&fontSize=75px&image=https%3A%2F%2Fassets.vercel.com%2fFupload%2Ffront%2Fassets%2Fdesign%2Fnextjs-black-logo.svg`}></meta>
      ...
      <header className={styles.header}>
        {home ? (
          <>
            <Image priority src="/images/profile.jpg" className={utilStyles.borderCircle} height={144} width={144} alt=""></Image>
